...
class Api {
     ...
     *
     * @return GlovoWorkingArea[]
     */
    public function getWorkingAreas() {
        return $this->exec( "GET", "/working-areas" );
    }
     ...
     * @return array
     */
    public function estimateOrderPrice( GlovoOrder $order ) {
     ...
     */
    public function createOrder( GlovoOrder $order ) {
