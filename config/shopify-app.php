...
return [
    ...
    */
    ...
    'esdk_enabled' => (bool) env('SHOPIFY_ESDK_ENABLED', false),
    ...
    */
    ...
    'webhooks' => [
        [
            'topic'     => env('SHOPIFY_WEBHOOK_UNINSTALL_TOPIC', 'app/uninstalled'),
            'address'   => env('SHOPIFY_APP_URL')."/webhook/app-uninstalled"
        ],
        [
            'topic'     => 'orders/create',
            'address'   => env('SHOPIFY_APP_URL')."/webhook/orders-created"
        ],
        [
            'topic'     => 'orders/paid',
            'address'   => env('SHOPIFY_APP_URL') . '/webhook/orders-paid'
        ],
        [
        ...
        #    'address'   => env('SHOPIFY_APP_URL') . '/webhook/orders-fulfilled'
        #]

        #[
        #    'topic'     => 'products/create',
        #    'address'   => env('SHOPIFY_APP_URL')."/webhook/products-created"
        #],[
        #    'topic'     => 'products/update',
        #    'address'   => env('SHOPIFY_APP_URL')."/webhook/products-updated"
        #],[
        #    'topic'     => 'products/delete',
        #    'address'   => env('SHOPIFY_APP_URL')."/webhook/products-delete"
        #]
    ],
